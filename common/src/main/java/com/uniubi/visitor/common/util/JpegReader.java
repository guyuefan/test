...
public class JpegReader {
    ...
    public static BufferedImage readImage(byte[] srcImg) throws IOException, ImageReadException {
        colorType = COLOR_TYPE_RGB;
        hasAdobeMarker = false;

        ImageInputStream stream = ImageIO.createImageInputStream(new ByteArrayInputStream(srcImg));
        ...
        while (iter.hasNext()) {
            ...
            try {
                ...
                checkAdobeMarker(srcImg);
                profile = Imaging.getICCProfile(srcImg);
    ...
    public static void checkAdobeMarker(byte[] srcImg) throws IOException, ImageReadException {
        JpegImageParser parser = new JpegImageParser();
        ByteSource byteSource = new ByteSourceArray(srcImg);
